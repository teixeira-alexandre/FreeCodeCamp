...
const deleteSong = (id) => {
  ...
  if (userData?.songs.length === 0){
    ...
    resetButton.style.cssText = "border: 2px solid #4d4d62; background-color: var(--secondary-color); color: var(--background-color); margin: auto; font-family: var(--font-headline); width: 200px; border-radius: 8px;";
